...
namespace LFNet.Common.Reflection
{
    ...
    internal class PropertyAccessor : MemberAccessor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:LFNet.Common.Reflection.PropertyAccessor" /> class.
        /// </summary>
        ...
        public PropertyAccessor(PropertyInfo propertyInfo)
        {
            ...
            this._hasGetter = this._propertyInfo.GetGetMethod(true) != null;
            if (this._hasGetter)
            {
                if (valueFactory == null)
                {
                    valueFactory = () => DelegateFactory.CreateGet(this._propertyInfo);
                }
                this._lateBoundGet = new Lazy<LateBoundGet>(valueFactory);
            }
            this._hasSetter = propertyInfo.GetSetMethod(true) != null;
            if (this._hasSetter)
            {
                if (func2 == null)
                {
                    func2 = () => DelegateFactory.CreateSet(this._propertyInfo);
                }
        ...
        public override object GetValue(object instance)
        {
            ...
            {
                throw new InvalidOperationException(string.Format("Property '{0}' does not have a getter.", this.Name));
            }
        ...
        public override void SetValue(object instance, object value)
        {
            ...
            {
                throw new InvalidOperationException(string.Format("Property '{0}' does not have a setter.", this.Name));
            }
