...
namespace LFNet.Common.Security
{
    public class Crc32 : HashAlgorithm
    {
        ...
        {
            this._crcValue ^= uint.MaxValue;
            while (--length >= 0)
            {
                this._crcValue = CrcTable[(int) ((IntPtr) ((this._crcValue ^ buffer[start++]) & 0xff))] ^ (this._crcValue >> 8);
            }
            this._crcValue ^= uint.MaxValue;
        }
        ...
        {
            base.HashValue = new byte[] { (byte) ((this._crcValue >> 0x18) & 0xff), (byte) ((this._crcValue >> 0x10) & 0xff), (byte) ((this._crcValue >> 8) & 0xff), (byte) (this._crcValue & 0xff) };
        ...
        public uint CrcValue
        {
            get
            {
                return (uint) ((((base.HashValue[0] << 0x18) | (base.HashValue[1] << 0x10)) | (base.HashValue[2] << 8)) | base.HashValue[3]);
            }
        }
