...
namespace LFNet.Common
{
    ...
    {
        private static int _processEachNumber = 20;

        /// <summary>
        /// 每次处理的记录数,默认20
        /// </summary>
        public static int ProcessEachNumber
        {
            get { return _processEachNumber; }
            set { _processEachNumber = value; }
        }

        private static string _logFileExtendName = "config";
        private static global::System.IO.TextWriter _messageWriter = null;
        private static global::System.IO.TextWriter _exceptionWriter = null;
        private static object locker = new object();
        ///<summary>
        /// 日志文件扩展名
        ///</summary>
        public static string LogFileExtendName
        {
            get { return _logFileExtendName; }
            set { _logFileExtendName = value; }
        }

        private static Queue _queues =Queue.Synchronized(new Queue());
        ...
        private static void AddAndRun(LogInfo logInfo)
        {
        ...
        private static void LogToMessageFile(List<LogInfo> messages)
        {
            ...
            if (_messageWriter == null)
            {
                ...
                _messageWriter = new global::System.IO.StreamWriter(file, true, Encoding.UTF8);
            }
