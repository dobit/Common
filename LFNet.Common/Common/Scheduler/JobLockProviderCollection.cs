...
{
    /// <summary>
    /// A <see cref="T:LFNet.Common.Scheduler.JobLockProvider" /> collection.
    /// </summary>
    public class JobLockProviderCollection : ProviderCollection
    {
        ...
        /// <summary>
        /// Gets the <see cref="T:LFNet.Common.Scheduler.JobLockProvider" /> with the specified name.
        /// </summary>
        /// <value>An instance of <see cref="T:LFNet.Common.Scheduler.JobLockProvider" />.</value>
        public JobLockProvider this[string name]
        {
            get
            {
