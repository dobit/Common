...
namespace System.Threading
{
    ...
    public class ThreadSafeRandom : Random
    {
        ...
        {
            return this._local.Value.Next(maxValue);
        }
        ...
        {
            return this._local.Value.Next(minValue, maxValue);
        }
        ...
        {
            this._local.Value.NextBytes(buffer);
        }
        ...
        {
            return this._local.Value.NextDouble();
        }
    }
}
